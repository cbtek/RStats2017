...
bool UIRStatsSSRN::onValidate()
{
    ...
    m_conditionLogger.addWarning(spare+order > 10000,
                                 "Total number of random values exceeds data limitation(10,000) imposed by ROCKET-STATS 2010.");
    ...
    m_conditionLogger.addWarning((order + spare > 10000),
                        "Total number of values to be generated exceed 10,000.  ROCKET-STATS 2017 will still work but this value exceeds data limits of previous versions.");
